...
DECT-2020 NR supports many features and use cases, ranging from audio streaming with scheduled access in a star network to IoT sensor deployments with random access in mesh networks.

We bring together developers who have started implementing stacks for different use cases, addressing different subsets of the standard's features. Members collaborate to converge their existing work into a unified, comprehensive reference stack – built from the community, for the community.
